...
public class World {
    ...
    static Location pl = new Location("Player");
    ...
    World(){
        ...
        Location pl = new Location("Player");
        ...
        Item sw = new Item(tr, "sword");
        Item la = new Item (hc, "lamp");
        Item dr = new Item (dc, "dragon");

        Item[] its = new Item [] {sw,la,dr};
        items = new ArrayList(Arrays.asList(its));
